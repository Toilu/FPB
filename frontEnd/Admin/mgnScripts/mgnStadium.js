var url = "http://localhost:8080/FPBws/webresources/entities.tbstadium";
...
function load(){
 ...
 function showItems(){
	...
	for(var i = from; i < to; ++i) {
		...
		'</td><td>' + jsonObj[i].CMainOwner.CFullName + 
		'</td><td>' + jsonObj[i].CMainOwner.CAddress + 
		'</td><td>' + jsonObj[i].CMainOwner.CPhoneNumber + 
		'</td><td>' + jsonObj[i].CMainOwner.CEmail + 
		'</td><td><a href="#" class="btn btn-link">View</a></td></tr>');
	}
