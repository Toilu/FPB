 ...
 */
@Stateless
@Path("entities.tbpricetable")
public class TbPriceTableFacadeREST extends AbstractFacade<TbPriceTable> {
    @PersistenceContext(unitName = "FPBwsPU")
    private EntityManager em;

    public TbPriceTableFacadeREST() {
        super(TbPriceTable.class);
    }
