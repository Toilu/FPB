 ...
 */
@Stateless
@Path("entities.tbreservation")
public class TbReservationFacadeREST extends AbstractFacade<TbReservation> {
    @PersistenceContext(unitName = "FPBwsPU")
    private EntityManager em;

    public TbReservationFacadeREST() {
        super(TbReservation.class);
    }
