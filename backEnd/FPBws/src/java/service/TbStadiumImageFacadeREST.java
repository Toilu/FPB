 ...
 */
@Stateless
@Path("entities.tbstadiumimage")
public class TbStadiumImageFacadeREST extends AbstractFacade<TbStadiumImage> {
    @PersistenceContext(unitName = "FPBwsPU")
    private EntityManager em;

    public TbStadiumImageFacadeREST() {
        super(TbStadiumImage.class);
    }
